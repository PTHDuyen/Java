...
public class Employee {
	...
	public Employee(int employeeId, String employeeName, Date birthDate, String gender, String hometown,
			String phoneNumber, Date hireDate, float overtimeHours, Position employeePosition,
	...
	public String toString() {
		return employeeId + "," + employeeName + "," + DATE_FORMAT.format(birthDate) + "," + gender + "," + hometown
				+ "," + phoneNumber + "," + DATE_FORMAT.format(hireDate) + "," + salary + "," + overtimeHours + ","
				+ employeePosition.getPositionName() + "," + employeeDepartment.getDepartmentName();
	}

	public Position positionNameCheck(String positionName) {
		final String FILE_NAME1 = "E:\\employeeManagerSoftware\\Position.txt";
	...
	public Department departmentNameCheck(String departmentName) {
		final String FILE_NAME2 = "E:\\employeeManagerSoftware\\Department.txt";
		Department employeeDepartment;
			...
			while ((line = reader.readLine()) != null) {
				...
				if (parts.length == 4) {
					if (parts[1].equals(departmentName)) {
						...
						employeeDepartment = new Department(departmentID, departmentName1, departmentAddress,
	...
	public int intput(String id, String name, String bỉrthDate, String gender, String homeTown, String phoneNumber,
