...
public class EmployeeManagement {
	...
	private static final String FILE_NAME = "E:\\employeeManagerSoftware\\Employee.txt";
	private static final String FILE_NAME1 = "E:\\employeeManagerSoftware\\Position.txt";
	private static final String FILE_NAME2 = "E:\\employeeManagerSoftware\\Department.txt";
		...
		try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
			...
			while ((line = reader.readLine()) != null) {
				...
				if (parts.length == 11) {
					...
					Employee employee = new Employee(id, name, birthDate, gender, hometown, phoneNumber, hireDate,
							overtimeHours, employeePosition, employeeDeparment);
