...
public class DepartmentManagement {
	...
	private static final String FILE_NAME = "E:\\employeeManagerSoftware\\Department.txt";
		...
		try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
			...
			while ((line = reader.readLine()) != null) {
				...
				if (parts.length == 4) {
					...
					Department x = new Department(departmentID, departmentName, departmentAddress,
